...
let currentAlsStores = globalThis.__unode_als_current_stores;
if (!(currentAlsStores instanceof Map)) {
  currentAlsStores = new Map();
  globalThis.__unode_als_current_stores = currentAlsStores;
}
