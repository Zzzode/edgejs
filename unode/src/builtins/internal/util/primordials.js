...
module.exports = {
  ...
  SafeFinalizationRegistry: typeof FinalizationRegistry === 'function' ? FinalizationRegistry : class SafeFinalizationRegistry {},
  SafeMap: Map,
  SafeSet: Set,
  SafeWeakRef: typeof WeakRef === 'function' ? WeakRef : class SafeWeakRef {},
  Symbol,
